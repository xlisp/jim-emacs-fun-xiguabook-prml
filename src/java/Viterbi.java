...
public class Viterbi {
	public static String[] states = { "#", "NN", "VB" };
	public static String[] observations = { "I", "write", "a letter" };
	public static double[] start_probability = { 0.3, 0.4, 0.3 };
	public static double[][] transition_probability = { { 0.2, 0.2, 0.6 },
			{ 0.4, 0.1, 0.5 }, { 0.1, 0.8, 0.1 } };
	public static double[][] emission_probability = { { 0.01, 0.02, 0.02 },
	...
	public static int[] copyIntArray(int[] ia, int newInt) {
